 ...
 * Array helper class.
 *
 * $Id: arr.php 4249 2009-04-21 03:52:56Z zombor $
 *
 * @package    Core
 * @author     Kohana Team
...
class arr_Core {
	...
	/**
	* Преобразует массив в массив целых чисел, м.б. полезно при обработке входа с формы.
	* @param array $a входящие данные
	* @return array если $a массив - массив целых, иначе - пустой массив
	* 
	* modified by Antuan
	*/
	public static function int_array($a){
		if(!is_array($a))
			return array();
		$b = array();
	    foreach($a as $k => $v) $b[$k] = intval($v);
