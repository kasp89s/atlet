...
abstract class Captcha_Driver {
	...
	{
        $result = strlen(Session::instance()->get('captcha_response')) && sha1(strtoupper($response)) === Session::instance()->get('captcha_response');
        Session::instance()->set('captcha_response', '');
        return ($result);
	}
