 ...
 * Router
 *
 * $Id: Router.php 3847 2008-12-28 17:00:54Z Shadowhand $
 *
 * @package    Core
 * @author     Kohana Team
...
class Router_Core {
	...
	public static function setup()
	{
		...
		foreach ($routes as $name => $route)
		{
			...
			if (preg_match('#^'.$regex.'$#u', Router::$current_uri, $matches))
			{
				 ...
				 * @modified by Antuan
				 */
				if (!empty($route['skip']) && $route['skip'] === TRUE)
					Router::$skip = TRUE;
	...
	public static function find_uri()
	{
		...
		Router::$current_uri = html::chars(Router::$current_uri, FALSE);
