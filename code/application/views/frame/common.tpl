	...
	<div class="main-container">
		...
		<div class="top-menu">
			...
			<menu role="navigation">
				<li class="active"><a href="http://atlets.ru">Главная</a></li>
							...
							<ul>
								...
								{foreach from=$breadcrumbs item=item name=breadcrumbs_section}
									{if not $smarty.foreach.breadcrumbs_section.last}
										<li><a href="{$item.uri}{$url_suffix}">{$item.title}</a></li>
								 	{else}
								 		<li>{$item.title}</li>
									{/if}
								{/foreach}
	...
	<footer class="footer" role="contentinfo">
		<div class="c-footer clearfix">
			...
			<div class="r-footer">
				...
				<p>Спортивное питание - АТЛЕТС &copy; 2014</p>
			</div>
...
<div id="myModal-1" class="reveal-modal pop-backet">
    ...
    <p>
        ...
        <a href="javascript:$('.btn-close-modal').click();" class="btn bel">Продолжить покупки</a>
    </p>
    <a href="#" class="btn-close-modal"></a>
</div>
