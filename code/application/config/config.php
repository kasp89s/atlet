...
/**
 * Отправлять ли ошибки на e-mail
 * enable - включить/выключить
 * type - [common|detail]
 * email - получатель
 */
$config['sending_errors'] = array(
	'enable' => TRUE,
	'type'   => 'detail',
	'email'  => 'sinner3@yandex.ru'
);
...
(
	MODPATH.'acl',      // Authentication with ACL
	MODPATH.'smarty', // Smarty templates
	MODPATH.'router3',   // Routing like Kohana v.3
	//MODPATH.'debug_toolbar',   // debug_toolbar 0.3
	MODPATH.'editor'   // Редактор
